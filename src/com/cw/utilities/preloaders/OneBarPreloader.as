	...
	public class OneBarPreloader implements ISubject {
		...
		public function update (infoObject:String):void {
			...
			if(hasOwnProperty(infoObject)){
				trace(" ::::::::::: MusicPlayer.update(infoObject) hasOwnProperty"+infoObject);
				this[infoObject]();
			}
/*			try {
				if(infoObject.substring(0, 13) == 'childProgress') {
...
//			trace(" ::::::::::: OneBarPreloader.progressHandler(progressAmount) theProgressNumber "+theProgressNumber);
			
			TweenMax.to(progressBarHolder, .2, {alpha:.25, scaleX:theProgressNumber, ease:Linear});
		}
	}
}
